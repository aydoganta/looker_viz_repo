  ...
  create: function(element) {
    element.innerHTML = `
      <style>
        ...
        .nh-top-header { background:#6E6EB5 !important; color: #1A1A1A; font-weight:700; text-align:center; padding:10px 6px; }
        .nh-sub-header { background:#6E6EB5 !important; color: #1A1A1A; font-weight:600; text-align:center; padding:8px 6px; }
