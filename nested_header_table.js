  ...
  create: function(element) {
    element.innerHTML = `
      <style>
        ...
        .nh-table thead th { background: #DBDBDB !important; font-weight:700; }
        .nh-top-header { background:#DBDBDB !important; color: #1F1F1F; font-weight:700; text-align:center; padding:10px 6px; }
        .nh-sub-header { background:#DBDBDB !important; color: #1F1F1F; font-weight:600; text-align:center; padding:8px 6px; }
